...
@section('title', 'User Door Access Create')
@section('content')
...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-stack"></i> User Door Access <small class="text-muted">Create</small></h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">User Door Access Create</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            ...
            <form class="form" action="{{ route('admin.usermcu.store') }}" id="form-create-usermcu" method="POST">
                @csrf
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="username_card" class="form-control" placeholder="..." name="username_card"
                                                value="{{ old('username_card') ? old('username_card') : '' }}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nama_lengkap" class="form-control" placeholder="..." name="nama_lengkap"
                                                value="{{ old('nama_lengkap') ? old('nama_lengkap') : '' }}">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-create-usermcu" onClick="changeToLoadingFormUserMcu()">Create</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormUserMcu() {
        var btn = document.getElementById('submit-create-usermcu');
    ...
    function submitFormUserMcu() {
        var form = document.getElementById('form-create-usermcu');
