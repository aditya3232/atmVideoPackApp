...
@section('title', 'Door Access Create')
@section('content')
...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-gear-fill"></i> Door Access <small class="text-muted">Create</small></h3>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Door Access Create</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            ...
            <form class="form" action="{{ route('admin.mcu.store') }}" id="form-create-mcu" method="POST">
                @csrf
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="door_token" class="form-control" placeholder="..." name="door_token"
                                                value="{{ old('door_token') ? old('door_token') : '' }}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="door_name_mcu" class="form-control" placeholder="..." name="door_name_mcu"
                                                value="{{ old('door_name_mcu') ? old('door_name_mcu') : '' }}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="type_mcu" class="form-control" placeholder="..." name="type_mcu"
                                                value="{{ old('type_mcu') ? old('type_mcu') : '' }}">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="keypad_password" class="form-control" placeholder="..." name="keypad_password"
                                                value="{{ old('keypad_password') ? old('keypad_password') : '' }}">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-create-mcu" onClick="changeToLoadingFormMcu()">Create</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormMcu() {
        var btn = document.getElementById('submit-create-mcu');
    ...
    function submitFormMcu() {
        var form = document.getElementById('form-create-mcu');
