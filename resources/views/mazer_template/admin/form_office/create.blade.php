    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><i class="bi bi-stack"></i> Office <small class="text-muted">Create</small></h3>
            </div>
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-create-office" onClick="changeToLoadingFormOffice()">Create</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormOffice() {
