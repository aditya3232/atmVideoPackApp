...
<div class="page-heading">
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            <div class="mb-4">
                <a href="{{ route('admin.index') }}" type="button" class="btn" style='border-radius:12px; background-color:#FFA500; color:white;'><i class="bi bi-arrow-return-left" style="font-size: 13px;"></i></a>
            </div>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="text-center">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span id="button_upload" class="btn btn-primary"><i class="bi bi-upload"></i> Update Avatar Baru</span>
            ...
            <div class="d-grid gap-2 mt-4">
                ...
                <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-update-profile" onClick="changeToLoadingFormUpdateUser()">Update</button>
            </div>
        </div>
    </section>
</div>
