...
<div class="page-heading">
    ...
    <section id="multiple-column-form">
        <div class="row match-height">
            ...
            <form class="form" action="{{ route('admin.regionaloffice.store') }}" id="form-create-regional-office" method="POST" onsubmit="return false;">
                @csrf
                <div class="col-12">
                    <div class="card">
            ...
            <div class="d-grid gap-2 mt-4">
                <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-create-regional-office"
                    onClick="changeToLoadingFormCreateRegionalOffice()">Create</button>
            </div>
        </div>
    </section>
</div>
...
<script>
    function changeToLoadingFormCreateRegionalOffice() {
        var btn = document.getElementById('submit-create-regional-office');
    ...
    function submitFormCreateRegionalOffice() {
        ...
        var form = document.getElementById('form-create-regional-office');
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Regional office failed to create.',
                    icon: 'error',
                    confirmButtonText: 'Ok'
                });
            }
