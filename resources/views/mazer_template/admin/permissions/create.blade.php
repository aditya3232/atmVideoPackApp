            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('admin.permissions.store') }}" id="form-create-permission" method="POST" onsubmit="return false;">
                                @csrf
                                <div class="row">
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    ...
                                    <button class="align-items-center col-12 btn btn-lg" type="submit" style='border-radius:12px; background-color:#56B000; color:white;' id="submit-create-permission"
                                        onClick="changeToLoadingFormCreatePermission()">Create</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script>
    function changeToLoadingFormCreatePermission() {
        var btn = document.getElementById('submit-create-permission');
        ...
        setTimeout(function () {
            ...
            // Submit the form
            submitFormCreatePermission();
        }, 2000);
    }

    function submitFormCreatePermission() {
        // Get the form element
        var form = document.getElementById('form-create-permission');
        ...
        xhr.onload = function () {
            if (xhr.status === 200) {
                ...
                Swal.fire({
                    title: 'Error!',
                    text: 'Permission failed to create.',
                    icon: 'error',
                    confirmButtonText: 'Ok'
                });
            }
